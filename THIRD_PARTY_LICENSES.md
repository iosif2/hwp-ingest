...
This project vendors a subset of `rhwp` for native HWP/HWPX parsing and PDF rendering.

- Vendored source: `vendor/rhwp-subset`
- rhwp license: MIT
- rhwp license copy: `licenses/rhwp-MIT.txt`
- rhwp upstream third-party notice copy: `vendor/rhwp-subset/THIRD_PARTY_LICENSES.rhwp.md`

The full upstream third-party license text copied at import time follows.
